...
const handler = createMcpHandler(
    (server) => {
        server.registerTool(
            "forecast_by_address",
            {
                title: "Forecast by Address",
                description: "Get probabilistic home value forecasts for any US street address. Returns current value, P10/P50/P90 forecast bands, appreciation percentage, reliability score, and fan chart data across 1-5 year horizons.",
                inputSchema: {
        ...
        server.registerTool(
            "forecast_by_h3_cell",
            {
                title: "Forecast by H3 Cell",
                description: "Get neighborhood-level home value forecasts by H3 hex cell ID at resolution 8.",
                inputSchema: {
        ...
        server.registerTool(
            "forecast_by_parcel",
            {
                title: "Forecast by Parcel ID",
                description: "Get lot-level home value forecasts by county tax parcel account ID.",
                inputSchema: {
