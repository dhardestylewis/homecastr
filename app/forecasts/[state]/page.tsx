...
export default async function StateHubPage({ params }: PageProps) {
    ...
    return (
        <div className="space-y-8">
            <DatasetJsonLd
                name={`${stateName} Home Price Forecasts`}
                description={`County-level home price forecast summaries for ${stateName}, generated by the Homecastr World Model.`}
                path={`/forecasts/${state}`}
