...
export default async function CityHubPage({ params, searchParams }: PageProps) {
    ...
    return (
        <div className="space-y-8">
            <DatasetJsonLd
                name={`${cityName} Neighborhood Forecasts`}
                description={`Neighborhood-level home price forecasts for ${cityName}, ${stateName}, generated by the Homecastr World Model.`}
                path={`/forecasts/${state}/${city}`}
            ...
            <header className="space-y-2">
                ...
                <DownloadButton state={state} city={city} />
            </header>
