...
\setbeamertemplate{footline}{%
  \ifnum\thepage>1\relax%
    \hbox to \paperwidth{%
      \kern1em\href{https://homecastr.com}{\includegraphics[height=0.35cm]{homecastr-logo-horizontal.png}}%
      \hfill%
...
\includegraphics[height=1.4cm]{homecastr-icon.png}%
}
...
\vfill
\begin{center}
\includegraphics[height=2cm]{homecastr-logo-horizontal.png}\\[16pt]
...
\centering
\href{https://homecastr.com}{\includegraphics[width=\linewidth,height=5cm,keepaspectratio=true]{dashboard_screenshot.png}}
\end{column}
\begin{column}{0.34\textwidth}
\centering
\statbox{25\%$^{*}$}{median error at 4yr}\\[14pt]
\statbox{4yr}{forecast horizon}\\[14pt]
\statbox{1M+}{properties forecasted}\\[14pt]
{\tiny\color{hcMuted}\centering $^{*}$MdAE, HCAD backtest, origin 2021.}
\end{column}
\end{columns}
...
\begin{tikzpicture}[scale=0.9]
  ...
  \node[inner sep=1pt] at (1.5,-2.2)
    {\includegraphics[width=1.8cm,height=0.45cm,keepaspectratio]{logo_corelogic.png}};

  % HouseCanary
  \node[inner sep=1pt] at (2.8,-1.8)
    {\includegraphics[width=1.8cm,height=0.45cm,keepaspectratio]{logo_housecanary.png}};

  % PropStream: launched AI/predictive features late 2024 (foreclosure factor, wholesale value)
  \node[inner sep=1pt] at (-3.2,1.5)
    {\includegraphics[width=1.8cm,height=0.45cm,keepaspectratio]{logo_propstream.png}};

  % Zillow: mostly current-state Zestimate, very product-led
  \node[inner sep=1pt] at (-2.5,2.8)
    {\includegraphics[width=1.8cm,height=0.45cm,keepaspectratio]{logo_zillow.png}};
  ...
  \node[inner sep=2pt, fill=hcCard, rounded corners=2pt] at (1.2,2.5)
    {\includegraphics[width=1.8cm,height=0.45cm,keepaspectratio]{logo_reventure.png}};

  % Homecastr — golden quadrant hero (slightly larger bounding box)
  \node[anchor=south west] at (3.6,2.8) {\includegraphics[width=2.2cm,height=0.55cm,keepaspectratio]{homecastr-logo-horizontal.png}};
...
\begin{tikzpicture}
  \node[circle, inner sep=0pt, minimum size=2.8cm, path picture={
    \node at (path picture bounding box.center) {\includegraphics[width=2.8cm]{dhl.png}};
  }] {};
\end{tikzpicture}\\[8pt]
